...
/// @nodoc
abstract class _$$SurahDetailImplCopyWith<$Res>
    implements $SurahDetailCopyWith<$Res> {
  factory _$$SurahDetailImplCopyWith(
          _$SurahDetailImpl value, $Res Function(_$SurahDetailImpl) then) =
      __$$SurahDetailImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int? number,
...
/// @nodoc
class __$$SurahDetailImplCopyWithImpl<$Res>
    extends _$SurahDetailCopyWithImpl<$Res, _$SurahDetailImpl>
    implements _$$SurahDetailImplCopyWith<$Res> {
  __$$SurahDetailImplCopyWithImpl(
      _$SurahDetailImpl _value, $Res Function(_$SurahDetailImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$SurahDetailImpl(
      number: freezed == number
          ? _value.number
          : number // ignore: cast_nullable_to_non_nullable
              as int?,
...
class _$SurahDetailImpl implements _SurahDetail {
  const _$SurahDetailImpl(
      {this.number,
      this.sequence,
      this.numberOfVerses,
      this.name,
  ...
  @override
  String toString() {
    return 'SurahDetail(number: $number, sequence: $sequence, numberOfVerses: $numberOfVerses, name: $name, revelation: $revelation, tafsir: $tafsir, preBismillah: $preBismillah, verses: $verses)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$SurahDetailImplCopyWith<_$SurahDetailImpl> get copyWith =>
      __$$SurahDetailImplCopyWithImpl<_$SurahDetailImpl>(this, _$identity);
}

abstract class _SurahDetail implements SurahDetail {
  const factory _SurahDetail(
      {final int? number,
      final int? sequence,
      final int? numberOfVerses,
      final Name? name,
      ...
      final Tafsir? tafsir,
      final PreBismillah? preBismillah,
      final List<Verse>? verses}) = _$SurahDetailImpl;
...
class _$PreBismillahImpl implements _PreBismillah {
  ...
  @override
  String toString() {
    return 'PreBismillah(text: $text, translation: $translation, audio: $audio)';
  }
...
class _$TransliterationImpl implements _Transliteration {
  const _$TransliterationImpl({this.en});
...
abstract class _Transliteration implements Transliteration {
  const factory _Transliteration({final String? en}) = _$TransliterationImpl;
